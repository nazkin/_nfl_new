...
def batch_fill_out_player_season_stats(season_year: int, season_type: str):
    # Bulk inserts all player stats #
    # From one season year and season type #
    ...
    for stats in team_players_stats:
        for player in stats["player_stats"]:
            ...
            p_model = PlayerSeasonStats(
                team_id=stats["team_id_db"],
                team_api_id=stats["team_api_id"],
            ...
            if player_db:
                ...
                p_model.player_api_id = (player_db.player_api_id,)
            else:
                # This player was not part of the roster
                continue
            ...
            if player.get("rushing"):
                ...
                p_model.rushing_redzone_attempts = player["rushing"].get(
                    "redzone_attempts"
                )
                p_model.rushing_brocken_tackles = player["rushing"].get(
                    "broken_tackles"
                )
            ...
            if player.get("receiving"):
                ...
                p_model.receiving_broken_tackles = player["receiving"].get(
                    "broken_tackles"
                )
                p_model.receiving_dropped_passes = player["receiving"].get(
                    "dropped_passes"
                )
            ...
            if player.get("passing"):
                ...
                p_model.passing_redzone_attempts = player["passing"].get(
                    "redzone_attempts"
                )
                ...
                p_model.passing_defended_passes = player["passing"].get(
                    "defended_passes"
                )
                ...
                p_model.passing_on_target_throws = player["passing"].get(
                    "on_target_throws"
                )
            else:
            ...
            if player.get("kick_returns"):
                p_model.kick_returns_avg_yards = (
                    player["kick_returns"].get("avg_yards"),
                )
            ...
            if player.get("int_returns"):
                p_model.int_returns_avg_yards = (
                    player["int_returns"].get("avg_yards"),
                )
                p_model.int_returns_yards = (player["int_returns"].get("yards"),)
                p_model.int_returns_longest = (player["int_returns"].get("longest"),)
                p_model.int_returns_touchdowns = (
                    player["int_returns"].get("touchdowns"),
                )
            ...
            if player.get("fumbles"):
                ...
                p_model.fumbles_own_rec_yards = (
                    player["fumbles"].get("own_rec_yards"),
                )
                p_model.fumbles_opp_rec = (player["fumbles"].get("opp_rec"),)
                p_model.fumbles_out_of_bounds = (
                    player["fumbles"].get("out_of_bounds"),
                )
                p_model.fumbles_forced_fumbles = (
                    player["fumbles"].get("forced_fumbles"),
                )
            ...
            if player.get("field_goals"):
                ...
                p_model.field_goals_avg_yards = (
                    player["field_goals"].get("avg_yards"),
                )
            ...
            if player.get("defence"):
                ...
                p_model.defence_interceptions = (
                    player["defense"].get("interceptions"),
                )
                p_model.defence_passes_defended = (
                    player["defense"].get("passes_defended"),
                )
                p_model.defence_forced_fumbles = (
                    player["defense"].get("forced_fumbles"),
                )
                ...
                p_model.defence_missed_tackles = (
                    player["defense"].get("missed_tackles"),
                )
                p_model.defence_batted_passes = (
                    player["defense"].get("batted_passes"),
                )
            ...
            if player.get("extra_points"):
                p_model.extra_points_kicks_attempts = (
                    player["extra_points"].get("attempts"),
                )
                p_model.extra_points_kicks_blocked = (
                    player["extra_points"].get("blocked"),
                )

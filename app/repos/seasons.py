...
def insert_season(seasons: List[SeasonSchedule]):
    with sessionmaker.begin() as session:
        ...
        for season in seasons:
            seasons_table_data.append(SeasonsTable(season_api_id=season.season_api_id, year=season.year, season_type=season.season_type, season_status=season.season_status))
